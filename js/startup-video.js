/**
 * Startup Video JavaScript
 * Simple question-subtitle pair with audio12
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showWelcomeMessage() {
        questionText.textContent = "Startup Support";
        questionText.classList.add('active', 'gold');
        voiceoverText.textContent = "Click play to discover flexible startup support solutions";
    ...
    function endPresentation() {
        ...
        setTimeout(() => {
            questionText.textContent = "Startup Strategy Complete";
            questionText.classList.add('active', 'gold');
            voiceoverText.textContent = "Ready to power-propel your entrepreneurship? Explore our case studies below.";
            voiceoverText.classList.add('active');
            progressBar.style.width = '100%';
        }, 500);
    }
